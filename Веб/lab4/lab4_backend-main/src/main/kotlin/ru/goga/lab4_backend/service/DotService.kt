...
import ru.goga.lab4_backend.DotChecker.checkDot
import ru.goga.lab4_backend.DotMapper
import ru.goga.lab4_backend.SecurityContext
import ru.goga.lab4_backend.data.responses.GetDotsResponse
import ru.goga.lab4_backend.dbobjects.Dot
import ru.goga.lab4_backend.repository.DotRepository
import ru.goga.lab4_backend.data.requests.CheckRequest
import ru.goga.lab4_backend.data.responses.CheckDotResponse
...
class DotService(
    ...
    fun completeCheckDot(checkRequest: CheckRequest): ResponseEntity<CheckDotResponse> {
        ...
        if (checkRequest.x !in -3f..5f || checkRequest.y !in -3f..5f || checkRequest.r !in -3f..5f) {
    ...
    fun getList(): List<GetDotsResponse> {
        ...
        return dots.sortedByDescending { it.time }.map { dotMapper.toDto(it) }
    }
